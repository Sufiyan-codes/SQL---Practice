...
LAST_VALUE(sales) OVER(PARTITION BY PRODUCTID ORDER BY SALES) HIGHEST_SALES
FROM SALES.ORDERS;
...
----  DAY 11 :- CTE (COMMON TABLE EX[RESSION)

-- Temparary named result set (visual table) that can be used multiple times
-- within your query to simplify & organnize complex query


--STEP 1:- Find the total sales for customer 
